...
<body class="animsition">
                    ...
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a href="{{route('admin#contactPage')}}">
                                <i class="fa-solid fa-circle-info"></i> Contact List
                            </a>
                        </li>
                    </ul>
                </nav>
                                    ...
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            @if (Auth::user()->image == null)
                                                ...
                                                @else
                                                    <img src="{{asset('image/default_female_user.webp')}}" class="img-thumbnail">
                                                @endif
                                            @else
    ...
    <script src="{{asset('admin/vendor/bootstrap-progressbar/bootstrap-progressb')}}ar.min.js">
    </script>
